...
## Introduction
Swasthx is a comprehensive healthcare technology platform designed to bridge the gap between patients and healthcare providers. Our ecosystem consists of multiple specialized platforms, each catering to different user needs.
